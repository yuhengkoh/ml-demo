...
destination_root = "/projects/group/jjkLee/e0688551/k_cross_opt"
...
for folder2 in folders:
    ...
    for i in hidden_dim_list:
        ...
        for k in lrlist:
            ...
            model,optimizer = train_model(df,y_label="z_norm", learn_rate=k, epoch0=10,batch_size0=12, hidden_dim0=i, to_save=False,opt_out=True)
            ...
            for j in range(20,301,10):
                ...
                model, optimizer = train_model(df,y_label="z_norm", learn_rate=k, epoch0=10, hidden_dim0=i,batch_size0=128, to_save=False, pre_trained_model=model, pre_optimizer=optimizer, opt_out=True)
